...
tap.equal(getAt([1,1, 0,15340,15341,99,1001,0,0], { numDatasets: 2, combinationMode: 'bivariate', breaks: bivBreaks  }, 0, 0), 12)
tap.equal(getAt([1,1, 0,15340,15341,101,1001,0,0], { numDatasets: 2, combinationMode: 'bivariate', breaks: bivBreaks  }, 0, 0), 13)
tap.equal(getAt([1, 1, 0,15340,15341,1001,0,0,0], { numDatasets: 2, combinationMode: 'bivariate', breaks: bivBreaks }, 0, 0), 3)
tap.equal(getAt([1, 1, 0,15340,15341,9999,9999,0,0], { numDatasets: 2, combinationMode: 'bivariate', breaks: bivBreaks }, 0, 0), 15)
tap.equal(getAt([1, 1, 0,15340,15341,99,99,0,0], { numDatasets: 2, combinationMode: 'bivariate', breaks: bivBreaks }, 0, 0), 0)
